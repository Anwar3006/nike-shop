        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-1 text-gray-700 text-center">
            <p className="mb-3 text-lg">
              Welcome to our guides section. Here you will find useful
              information about our products and how to get the most out of
              them.
            </p>
            ...
            <p>
              ...
              Our sizing guide will help you find the perfect size for your
              feet.
            </p>
            ...
            <h2 className="text-2xl font-semibold mt-6">
              3. Apparel Care Guide
            </h2>
            <p>
              Our apparel is designed to perform. Follow our care instructions
              to ensure your Nike apparel stays in great condition.
            </p>
