      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-1 text-gray-700 text-center">
            <p>
              Welcome to the Nike Shop. These Terms of Use (&quot;Terms&quot;)
              govern your access to and use of our website, products, and
              services (collectively, the &quot;Services&quot;). Please read
            ...
            <p>
              ...
              of the Services after the changes have been posted will constitute
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                ...
                determined by us, may harm us or users of the Services.
              </li>
              <li>
            ...
            <p>
              ...
              design, selection, and arrangement thereof) are owned by Nike, its
