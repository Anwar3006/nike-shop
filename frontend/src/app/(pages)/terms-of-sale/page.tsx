      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-700">
            <p>
              These Terms of Sale (&quot;Terms&quot;) apply to all purchases of products
              from the Nike Shop. Please read these Terms carefully before placing
              an order.
            </p>
            ...
            <h2 className="text-2xl font-semibold mt-6">2. Pricing and Payment</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mt-6">3. Shipping and Delivery</h2>
            <p>
