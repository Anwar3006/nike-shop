...
export const createPaymentIntentHandler = catchAsync(async (req, res, next) => {
    try {
        ...
        const { clientSecret } = await createPaymentIntent(amount, userId, shippingAddressId, cart);
