...
import { shoes, colorVariant, images, shoeSizes, sizes, category, } from "../../models/shoes.model.js";
    ...
    try {
        ...
        for (const shoeData of seedData) {
            ...
            for (const variantData of shoeData.colors) {
                ...
                const availableSizes = allSizes.slice(0, Math.floor(Math.random() * 10) + 8); // 8-18 sizes available
