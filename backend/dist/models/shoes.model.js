import { check, decimal, index, integer, pgTable, primaryKey, serial, text, timestamp, uniqueIndex, uuid, varchar, } from "drizzle-orm/pg-core";
...
export const shoes = pgTable("shoes", {
    ...
    baseImage: varchar("base_image")
        .notNull()
        .default("https://atlas-content-cdn.pixelsquid.com/stock-images/nike-shoe-box-open-shoebox-047RRRB-600.jpg"),
...
export const colorVariantRelations = relations(colorVariant, ({ one, many }) => ({
    shoe: one(shoes, {
